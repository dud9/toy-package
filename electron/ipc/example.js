...
exports.getUrl = function (event, channel, res) {
  return global.store.get('url')
}

exports.clearUrl = function (event, channel, res) {
  if (global.store.get('url')) global.store.delete('url')
}

exports.getEquipIp = function (event, channel, res) {
  return fs.readFileSync('./resources/extraResources/equip.js').toString()
}
